...
LoginManager = {
 ...
 handleError: function (err) {
   switch (err.reason) {
     case 'User not found':
        AlertsManager.showAlert({type: 'danger', message: 'Email is incorrect'});
      case 'Email already exists.':
        AlertsManager.showAlert({type: 'danger', message: 'Email already exists'});
      case 'Incorrect password':
        AlertsManager.showAlert({type: 'danger', message: 'Incorrect password'});
        break;
   }
   console.log(err)
 }
